package com.goormthon.exception.handler;

import com.goormthon.exception.ErrorResponse;
import com.goormthon.exception.custom.GroomClientErrorException;
import com.goormthon.exception.custom.GroomServerErrorException;
import com.goormthon.exception.errorcode.ClientErrorCode;
import com.goormthon.exception.errorcode.ResponseErrorCode;
...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(GroomClientErrorException.class)
    public ResponseEntity<ErrorResponse> handleClientException(GroomClientErrorException exception) {
        logClientError(exception);
        return toResponse(exception.getHttpStatus(), exception.getMessage());
    }

    @ExceptionHandler(GroomServerErrorException.class)
    public ResponseEntity<ErrorResponse> handleServerException(GroomServerErrorException exception) {
        logServerError(exception);
        return toResponse(exception.getHttpStatus(), exception.getMessage());
    }
